...
<body onload="qrcodevalue()">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 header" style="border: 1px solid #000 ; border-radius: 5px ; background-color: rgb(215, 252, 243);">
                ...
                <div class="col-lg-8">
                    ...
                    <h6 class="text-left" id="Street"><b>Address :</b><?php echo $street." ".$street1." ".$city;echo ", "; echo $state."  ".$zip ?></h6>  
                <br>
...
<br>
                    ...
                    <h6> विधानसभा निर्वाचन क्षेत्र संख्या व नाम : <?php echo $AC_no;  ?><br> Assembly Constituency No. and Name :<?php echo $AC_no;  ?></h6> <br>
                    <h6>मतदान केंद्र का पता : 
                       <br> Polling Station Address :  <?php echo $street." ".$street1." ".$city;echo ", "; echo $state."  ".$zip?></h6>
